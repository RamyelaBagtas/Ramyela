  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch products
        const productsResponse = await axiosInstance.get(`api/exproducts/user/${userId}`);
...
export default EXSCompleteOrder;
