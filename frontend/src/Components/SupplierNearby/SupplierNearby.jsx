...
const SupplierNearby = () => {
    ...
    useEffect(() => {
        const fetchProviders = async () => {
            ...
            try {
                const response = await axiosInstance.get(`api/nearest/supplier/${userId}`, {
        ...
        const postCoordinatesAndFetchProviders = async () => {
            ...
            try {
                await axiosInstance.post(`api/nearest/supplierr/${userId}`, {
                    maxDistance: 10000
                });
    ...
    const navigateTo = (providerUserId) => {
        window.location.href = `/supplierproductdisplay/${providerUserId}`;
    };
