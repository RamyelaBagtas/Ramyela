...
const Navbar = ({ onLogout, onCart, onProfile }) => {
    ...
    return (
        <div className="navbar">
            ...
            <div className="nav-shop-links">
                <button onClick={() => navigateTo("/ppppp")}>Shop</button>
            </div>
            <div className="nav-icons">
                <button className="cart" onClick={() => navigateTo("/cart")}>
                ...
                <div className="profile" onClick={toggleDropdown}>
                    ...
                    {showDropdown && (
                        <div className="dropdown">
                            <button onClick={() => navigateTo("/accsetting")}>Account Settings</button>
                            <button onClick={() => navigateTo("/order")}>My Purchase</button>
