    ...
    return (
        <div className="navbar">
            ...
            <div className="nav-shop-links">
                <button onClick={() => navigateTo("/ssandrs")}>Shop</button>
            </div>
                    ...
                    <div className="profile" onClick={toggleDropdown}>
                        ...
                        {showDropdown && (
                            <div className="dropdown">
                                <button onClick={() => navigateTo("/seller")}>Dashboard</button>
                                <button onClick={() => navigateTo("/sellerorder")}>Purchase</button>
                                <button onClick={() => navigateTo("/provsetting")}>Account Settings</button>
