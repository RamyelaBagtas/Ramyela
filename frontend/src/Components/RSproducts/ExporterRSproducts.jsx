...
const ExporterRSproducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axiosInstance.get('api/rsproducts/displaysuser');
...
export default ExporterRSproducts;
